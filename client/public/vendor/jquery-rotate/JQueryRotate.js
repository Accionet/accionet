...
(function ($) {
  let supportedCSS, supportedCSSOrigin, styles = document.getElementsByTagName('head')[0].style, toCheck = 'transformProperty WebkitTransform OTransform msTransform MozTransform'.split(' ');
  ...
  Wilq32.PhotoEffect.prototype = {
    ...
    _emptyFunction() {},
    _defaultEasing(x, t, b, c, d) { return -c * ((t = t / d - 1) * t * t * t - 1) + b; },
