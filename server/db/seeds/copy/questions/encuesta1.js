const optionsQ1 = require('../options/encuesta1Q1');
const optionsQ2 = require('../options/encuesta1Q2');
const optionsQ3 = require('../options/encuesta1Q3');
const optionsQ4 = require('../options/encuesta1Q4');
