...
//Return all the users active or not
exports.all = function(callback) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        var query = client.query("SELECT * FROM" + table_name + "ORDER BY lastName ASC;");
...
//Creates a json representing an empty user
...
exports.findOne = function(data, callback) {
  //Should create a query with the data and return the first
  return null;
};

exports.findAll = function(data, callback) {
  //Should create a query with the data and return all
  return null;
};

exports.find = function(data, limit, callback) {
  //Should create a query with the data and return the amount designated in limit
  return null;
};

//
// /*Recieves a json with attr and parse them to become a user with all the attributes */
// function parseToUser(attr) {
//
//
//     var place = {
//         keys: [],
